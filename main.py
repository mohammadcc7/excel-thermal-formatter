...
def format_excel_for_thermal(input_path, output_path, remove_empty=True):
    ...
    for ws in wb.worksheets:
        ...
        # إزالة الصفوف فارغة الكمية (في حال تفعيل الخيار)
        ...
        # إعداد الخطوط البارزة والحدود والتظليل
        ...
        # توزيع أبعاد الأعمدة تناسبياً لورق 8سم
        total_units = 38
        if max_c > 1:
        ...
        # إزالة الهوامش وإعداد الصفحة للطباعة الحرارية
